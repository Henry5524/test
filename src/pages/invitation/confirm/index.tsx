import { LandingPage, Message, PromoButton, VirtanaLogo } from '@components';
...
export const OrganizationInvitationConfirmPage: React.FunctionComponent<{}> = () => {
    ...
    const { query: { token }, basePath } = router;

    const confirmOrganizationInvitationHandler = () => {
        setLoading(true);
        setError({ message: null });
        Auth.organizationInvitationConfirm(token as string)
            .then(() => {
                setLoading(false);
                setComplete(true);
            })
    ...
    const formik = useFormik({
        ...
        onSubmit: () => {
            confirmOrganizationInvitationHandler();
        },
    });
            ...
            <Container component="main" maxWidth="xs">
                {
                    ...
                    <div className={classes.paper}>
                        ...
                        <div className={classes.wrapper}>
                            <Typography className={classes.subTitle}>Accept Organization Invitation</Typography>
                        </div>
                        <form
                            data-cy="organizationInvitationConfirmForm"
                            className={classes.form}
                            onSubmit={formik.handleSubmit}
                        >
                            <div className={classes.wrapper}>
                                <PromoButton
                                    dataCy="organizationInvitationConfirmSubmit"
                                    type="submit"
                                    disabled={loading}
                                    fullWidth
                                    variant="contained"
                    ...
                    <div className={classes.complete}>
                        ...
                        <div>
                            <Typography className={clsx(classes.subTitle, classes.subTitle2)}>
                                Organization confirmation is complete.
                            </Typography>
                        </div>
                        <PromoButton
                            type="button"
...
export default OrganizationInvitationConfirmPage;
